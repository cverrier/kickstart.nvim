...
vim.keymap.set('n', '<leader>te', '<cmd>vsplit term://$SHELL<CR>', { desc = 'Open [Te]rminal in a vertical split' })
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      local parsers = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'python', 'query', 'vim', 'vimdoc', 'rust', 'toml' }
